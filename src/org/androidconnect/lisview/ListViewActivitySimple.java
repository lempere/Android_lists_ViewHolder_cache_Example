...
import org.androidconnect.lisview.arrayadapter.ArraySimple;
...
public class ListViewActivitySimple extends ListActivity {
    /** Called when the activity is first created. */
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //Create new Adapter from the String Array Global.countries
        ArrayAdapter<String> countriesSimpleAdapter = new ArraySimple(getApplicationContext());
        //Set Adapter to ListActivity
        setListAdapter(countriesSimpleAdapter);
