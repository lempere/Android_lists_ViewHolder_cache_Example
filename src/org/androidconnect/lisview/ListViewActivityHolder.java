...
import org.androidconnect.lisview.arrayadapter.ArrayHolder;
...
public class ListViewActivityHolder extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> countriesHolderAdapter = new ArrayHolder(this);
        //Set Adapter to ListActivity
        setListAdapter(countriesHolderAdapter);
